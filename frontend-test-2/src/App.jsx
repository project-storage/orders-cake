...
import { CAKE_PATH, DASHBOARD_PATH, DEGREE_PATH, DEPARTMENT_PATH, GROUP_PATH, UPDATE_CAKEA_PATH, UPDATE_DEGREE_PATH, UPDATE_GROUP_PATH } from './configs/constrants'
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<SuperAdminLayout />}>
          ...
          {/* <Route path={`${UPDATE_GROUP_PATH}/:id`} element={<UpdateGr />} /> */}
