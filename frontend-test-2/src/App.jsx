...
import { ALL_USER_PATH, CAKE_PATH, DASHBOARD_PATH, DEGREE_PATH, DEPARTMENT_PATH, GROUP_PATH, UPDATE_CAKEA_PATH, UPDATE_DEGREE_PATH, UPDATE_DEPARTMENT_PATH, UPDATE_GROUP_PATH, UPDATE_USER } from './configs/constrants'
