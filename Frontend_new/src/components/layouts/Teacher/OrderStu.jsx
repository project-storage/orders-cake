...
function insertStu() {
    Swal.fire({
      title: "เพิ่มนักเรียน นักศึกษา",
      html: `
      <label for="swal-input1" style="width: 120px;">รหัสนักศึกษา:</label><input type="text" id="title" class="swal2-input""><br>
      <label for="swal-input1" style="width: 120px;">หมายเลขบัตรประชาชน:</label><input type="text" id="name" class="swal2-input" ><br>
      ...
      <label for="swal-input1" style="width: 120px;">แผนก:</label><input type="text" id="username" class="swal2-input" ><br>
      <label for="swal-input1" style="width: 120px;">ชั้น:</label><input type="text" id="email" class="swal2-input" ><br>
      <label for="swal-input1" style="width: 120px;">ห้อง:</label><input type="text" id="email" class="swal2-input" ><br>
